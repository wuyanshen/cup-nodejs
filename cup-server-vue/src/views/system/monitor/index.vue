    ...
    <div v-if="show">
      <el-card class="box-card">
        <div style="color: #666;font-size: 13px;">
          ...
          <span>
            服务器已不间断运行：{{ data.sys.day }}
          </span>
          <span>
            项目运行时间：{{ data.sys.pUpTime }}
          </span>
          <i class="el-icon-refresh" style="margin-left: 20px" @click="init" />
        </div>
      </el-card>
      <el-card class="box-card">
...
<script>
import { sysInfo } from '@/api/monitor'
